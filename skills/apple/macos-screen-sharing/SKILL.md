...
tags: [macos, screen-sharing, vnc, headless, remote-desktop, thunderbolt-bridge]
triggers:
  - user asks to connect to another Mac via Screen Sharing / VNC
  - user reports Screen Sharing issues on headless Mac (no physical monitor)
  - user asks about Thunderbolt Bridge for remote desktop
  - user reports click issues / phantom menu bar clicks in Screen Sharing
  - user asks to optimize Screen Sharing performance between Macs
---
