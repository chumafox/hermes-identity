...
description: Benchmark local LLM and TTS inference speed and memory on Apple Silicon (M1/M2/M3/M4). Tests Ollama (llama.cpp Metal), mlx-lm for text, and mlx-audio for TTS models. Memory-safe methodology for constrained machines (8GB).
version: 1.0.0
author: Hermes Agent
license: MIT
platforms: [macos]
